...
context_cat_features = ["OD","officeID"]
context_num_features = ['staySaturday','isContinental','isDomestic','depWeekDay','dtd']


alt_num_features = [ 'stayDurationMinutes', 'totalPrice',
       'totalTripDurationMinutes', 'nAirlines', 'nFlights', 
        'outDepTime', 'outArrTime']

alt_cat_features = ["firstAirline"]

alt_seq_cols = ["airlines"]
...
parser.add_argument('--testset', type=str, default="testset.p",
...
testdf = pickle.load( open( args.testset, "rb" ))
